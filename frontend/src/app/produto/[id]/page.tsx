...
export default function ProdutoPage({
  ...
  return (
    <main className="flex flex-col min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="max-w-full overflow-x-auto px-4 mt-5">
        <div className="flex flex-col md:flex-row gap-8 md:gap-20 justify-center items-start w-max">
          {/* Carrossel */}
          ...
          <div className="flex flex-col gap-5 flex-1 min-w-[280px]">
            {/* título, preço, badges e quantidade */}
